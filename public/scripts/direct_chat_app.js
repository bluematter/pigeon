...
},{"backbone":4,"underscore":15}],2:[function(require,module,exports){
...
},{"backbone":4,"backbone.babysitter":1,"backbone.wreqr":3,"underscore":15}],3:[function(require,module,exports){
...
},{"backbone":4,"underscore":15}],4:[function(require,module,exports){
(function (global){
//     Backbone.js 1.2.3
...
},{"jquery":14,"underscore":15}],5:[function(require,module,exports){
'use strict';
...
},{"../../../params":23,"../../templates/views/directMessage.hbs":21,"../../templates/views/directMessagesView.hbs":22,"backbone.marionette":2,"jquery":14}],21:[function(require,module,exports){
// hbsfy compiled Handlebars template
var HandlebarsCompiler = require('hbsfy/runtime');
module.exports = HandlebarsCompiler.template({"1":function(depth0,helpers,partials,data) {
    var helper;

  return "		  <span class=\"user-name\"><strong>"
  ...
  return "		  <span class=\"time-stamp ml-5\">["
  ...
  return "    	  <span class=\"text\">"
    ...
    return "          <span class=\"text color--red\">Somehow the message didnt go through? It's really impossible for this message to show up, if it has then you are a god...</span>\n";
  ...
  return "<div class=\""
    ...
    + "\">\n    <div>\n"
    + ((stack1 = helpers['if'].call(depth0,(depth0 != null ? depth0.nickname : depth0),{"name":"if","hash":{},"fn":this.program(1, data, 0),"inverse":this.noop,"data":data})) != null ? stack1 : "")
    + ((stack1 = helpers['if'].call(depth0,(depth0 != null ? depth0.timeStamp : depth0),{"name":"if","hash":{},"fn":this.program(3, data, 0),"inverse":this.noop,"data":data})) != null ? stack1 : "")
    + "	</div>\n	<div>\n"
    + ((stack1 = helpers['if'].call(depth0,(depth0 != null ? depth0.message : depth0),{"name":"if","hash":{},"fn":this.program(5, data, 0),"inverse":this.program(7, data, 0),"data":data})) != null ? stack1 : "")
    + "	</div>\n</div>";
},"useData":true});
...
module.exports = HandlebarsCompiler.template({"compiler":[6,">= 2.0.0-beta.1"],"main":function(depth0,helpers,partials,data) {
  ...
  return "<div id=\""
    + alias3(((helper = (helper = helpers.chatID || (depth0 != null ? depth0.chatID : depth0)) != null ? helper : alias1),(typeof helper === alias2 ? helper.call(depth0,{"name":"chatID","hash":{},"data":data}) : helper)))
    + "\">\n    \n    <!-- chat hack for other ID -->\n    <input id=\""
